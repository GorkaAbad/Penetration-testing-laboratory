...
<div class="container" id="contenido">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <h1 class="my-4 text-primary">Welcome back
                <?php echo $name; ?>
            </h1>
            <!-- Esto deberia de hacerse con JS -->
            <div class="list-group">
                <a href="#" id="all" onclick="mostrarTodos()" class="list-group-item active">All</a>
                <a href="#" id="undone" onclick="mostrarNoConseguidos()" class="list-group-item">Undone</a>
                <a href="#" id="done" onclick="mostrarConseguidos()" class="list-group-item ">Done</a>
                <input id="search" placeholder="Search" class="list-group-item" onkeypress="search(this)" required="true">
            </div>
                ...
                foreach ($containers
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" id=<?php echo $container["cve_container"] . "CARD"; ?>>
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a name=<?php echo($container["cve_container"]); ?> href= <?php echo("container.php?cve=" . $container["cve_container"]); ?>>
